...
#ifndef VEHICLE_CORE__SRV__DETAIL__REQUEST_INTERNAL_CONTROL__FUNCTIONS_H_
#define VEHICLE_CORE__SRV__DETAIL__REQUEST_INTERNAL_CONTROL__FUNCTIONS_H_
...
/// Initialize srv/RequestInternalControl message.
/**
...
/// Finalize srv/RequestInternalControl message.
/**
...
/// Create srv/RequestInternalControl message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vehicle_core__srv__RequestInternalControl_Request__init().
...
/// Destroy srv/RequestInternalControl message.
/**
 * It calls
 * vehicle_core__srv__RequestInternalControl_Request__fini()
...
/// Check for srv/RequestInternalControl message equality.
/**
...
/// Copy a srv/RequestInternalControl message.
/**
...
/// Initialize array of srv/RequestInternalControl messages.
/**
...
/// Finalize array of srv/RequestInternalControl messages.
/**
 * It calls
 * vehicle_core__srv__RequestInternalControl_Request__fini()
...
/// Create array of srv/RequestInternalControl messages.
/**
 * It allocates the memory for the array and calls
 * vehicle_core__srv__RequestInternalControl_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RequestInternalControl messages.
/**
 * It calls
 * vehicle_core__srv__RequestInternalControl_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RequestInternalControl message array equality.
/**
...
/// Copy an array of srv/RequestInternalControl messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vehicle_core__srv__RequestInternalControl_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vehicle_core
...
/**
 * It calls
 * vehicle_core__srv__RequestInternalControl_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_vehicle_core
...
/**
 * It allocates the memory for the array and calls
 * vehicle_core__srv__RequestInternalControl_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vehicle_core
...
/**
 * It calls
 * vehicle_core__srv__RequestInternalControl_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VEHICLE_CORE__SRV__DETAIL__REQUEST_INTERNAL_CONTROL__FUNCTIONS_H_
