...
#ifndef VEHICLE_CORE__MSG__DETAIL__DRIVE_FEEDBACK__FUNCTIONS_H_
#define VEHICLE_CORE__MSG__DETAIL__DRIVE_FEEDBACK__FUNCTIONS_H_
 ...
 * calls
 * vehicle_core__msg__DriveFeedback__init().
...
/**
 * It calls
 * vehicle_core__msg__DriveFeedback__fini()
 ...
 * vehicle_core__msg__DriveFeedback__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * vehicle_core__msg__DriveFeedback__Sequence__fini()
 * on the array,
...
#endif  // VEHICLE_CORE__MSG__DETAIL__DRIVE_FEEDBACK__FUNCTIONS_H_
