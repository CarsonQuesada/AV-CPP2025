...
#ifndef VEHICLE_CORE__MSG__DETAIL__MAX_SPEED__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
#define VEHICLE_CORE__MSG__DETAIL__MAX_SPEED__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
...
#endif  // VEHICLE_CORE__MSG__DETAIL__MAX_SPEED__ROSIDL_TYPESUPPORT_FASTRTPS_C_H_
