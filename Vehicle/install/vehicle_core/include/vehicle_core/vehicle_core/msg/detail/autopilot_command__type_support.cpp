...
{
  new (message_memory) vehicle_core::msg::AutopilotCommand(_init);
}

void AutopilotCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vehicle_core::msg::AutopilotCommand *>(message_memory);
  typed_message->~AutopilotCommand();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember AutopilotCommand_message_member_array[1] = {
  {
    "action",  // name
    ...
    offsetof(vehicle_core::msg::AutopilotCommand, action),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AutopilotCommand_message_members = {
  ...
  1,  // number of fields
  sizeof(vehicle_core::msg::AutopilotCommand),
...
{
  return &::vehicle_core::msg::rosidl_typesupport_introspection_cpp::AutopilotCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vehicle_core, msg, AutopilotCommand)() {
  return &::vehicle_core::msg::rosidl_typesupport_introspection_cpp::AutopilotCommand_message_type_support_handle;
}
