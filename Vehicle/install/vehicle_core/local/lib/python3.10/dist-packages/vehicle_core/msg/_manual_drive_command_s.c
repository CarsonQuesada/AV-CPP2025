...
bool vehicle_core__msg__manual_drive_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_core.msg._manual_drive_command.ManualDriveCommand", full_classname_dest, 57) == 0);
  }
  vehicle_core__msg__ManualDriveCommand * ros_message = _ros_message;
  {  // brake
  ...
  {  // steer
    ...
    assert(PyLong_Check(field));
    ros_message->steer = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ManualDriveCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_core.msg._manual_drive_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ManualDriveCommand");
  ...
  {  // steer
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->steer);
    {
