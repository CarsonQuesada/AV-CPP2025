...
class Metaclass_InternalDriveCommand(type):
    """Metaclass of message 'InternalDriveCommand'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'vehicle_core.msg.InternalDriveCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__internal_drive_command
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__internal_drive_command
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__internal_drive_command
            cls._TYPE_SUPPORT = module.type_support_msg__msg__internal_drive_command
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__internal_drive_command
...
class InternalDriveCommand(metaclass=Metaclass_InternalDriveCommand):
    """Message class 'InternalDriveCommand'."""
