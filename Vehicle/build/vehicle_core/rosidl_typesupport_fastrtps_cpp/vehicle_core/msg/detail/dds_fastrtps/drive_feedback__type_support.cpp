...
#include "vehicle_core/msg/detail/drive_feedback__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_core::msg::DriveFeedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vehicle_core::msg::DriveFeedback *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_core::msg::DriveFeedback *>(
    untyped_ros_message);
...
{
  return &vehicle_core::msg::typesupport_fastrtps_cpp::_DriveFeedback__handle;
}
