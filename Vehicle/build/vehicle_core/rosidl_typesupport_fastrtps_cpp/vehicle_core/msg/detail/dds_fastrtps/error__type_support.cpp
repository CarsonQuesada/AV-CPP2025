...
#include "vehicle_core/msg/detail/error__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_core::msg::Error;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vehicle_core::msg::Error *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_core::msg::Error *>(
    untyped_ros_message);
...
{
  return &vehicle_core::msg::typesupport_fastrtps_cpp::_Error__handle;
}
