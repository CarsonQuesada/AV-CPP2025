...
#include "vehicle_core/msg/detail/autopilot_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vehicle_core::msg::AutopilotCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vehicle_core::msg::AutopilotCommand & ros_message)
{
  // Member: action
  cdr >> ros_message.action;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_core::msg::AutopilotCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vehicle_core::msg::AutopilotCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_core::msg::AutopilotCommand *>(
    untyped_ros_message);
...
static size_t _AutopilotCommand__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_AutopilotCommand(full_bounded, is_plain, 0);
...
get_message_type_support_handle<vehicle_core::msg::AutopilotCommand>()
{
  return &vehicle_core::msg::typesupport_fastrtps_cpp::_AutopilotCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_core, msg, AutopilotCommand)() {
  return &vehicle_core::msg::typesupport_fastrtps_cpp::_AutopilotCommand__handle;
}
