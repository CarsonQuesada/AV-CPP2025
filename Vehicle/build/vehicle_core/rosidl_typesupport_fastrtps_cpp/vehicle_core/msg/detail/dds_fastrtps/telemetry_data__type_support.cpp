...
#include "vehicle_core/msg/detail/telemetry_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vehicle_core::msg::TelemetryData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vehicle_core::msg::TelemetryData & ros_message)
{
  // Member: gps_online
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_core::msg::TelemetryData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vehicle_core::msg::TelemetryData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vehicle_core::msg::TelemetryData *>(
    untyped_ros_message);
...
{
  return &vehicle_core::msg::typesupport_fastrtps_cpp::_TelemetryData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_core, msg, TelemetryData)() {
  return &vehicle_core::msg::typesupport_fastrtps_cpp::_TelemetryData__handle;
}
