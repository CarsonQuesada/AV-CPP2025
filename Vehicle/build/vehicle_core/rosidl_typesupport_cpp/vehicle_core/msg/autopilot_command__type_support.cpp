...
static const _AutopilotCommand_type_support_symbol_names_t _AutopilotCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vehicle_core, msg, AutopilotCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vehicle_core, msg, AutopilotCommand)),
  }
};
...
{
  return &::vehicle_core::msg::rosidl_typesupport_cpp::AutopilotCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vehicle_core, msg, AutopilotCommand)() {
  return get_message_type_support_handle<vehicle_core::msg::AutopilotCommand>();
}
