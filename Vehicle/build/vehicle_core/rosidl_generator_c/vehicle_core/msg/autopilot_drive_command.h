...
#ifndef VEHICLE_CORE__MSG__AUTOPILOT_DRIVE_COMMAND_H_
#define VEHICLE_CORE__MSG__AUTOPILOT_DRIVE_COMMAND_H_
...
#endif  // VEHICLE_CORE__MSG__AUTOPILOT_DRIVE_COMMAND_H_
