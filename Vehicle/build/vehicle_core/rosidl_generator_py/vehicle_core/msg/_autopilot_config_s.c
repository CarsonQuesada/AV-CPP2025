...
bool vehicle_core__msg__autopilot_config__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vehicle_core.msg._autopilot_config.AutopilotConfig", full_classname_dest, 50) == 0);
  }
  vehicle_core__msg__AutopilotConfig * ros_message = _ros_message;
  {  // profile_id
...
{
  /* NOTE(esteve): Call constructor of AutopilotConfig */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vehicle_core.msg._autopilot_config");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AutopilotConfig");
