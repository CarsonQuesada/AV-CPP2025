...
#include "vehicle_core/msg/detail/autopilot_status__rosidl_typesupport_fastrtps_c.h"
...
using _AutopilotStatus__ros_msg_type = vehicle_core__msg__AutopilotStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AutopilotStatus__ros_msg_type * ros_message = static_cast<const _AutopilotStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: autopilot_ready
  {
    cdr << (ros_message->autopilot_ready ? true : false);
  }

  // Field name: lidar_ready
  {
    cdr << (ros_message->lidar_ready ? true : false);
  }

  // Field name: camera_ready
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AutopilotStatus__ros_msg_type * ros_message = static_cast<_AutopilotStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: autopilot_ready
  {
    uint8_t tmp;
    cdr >> tmp;
...
static uint32_t _AutopilotStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_core__msg__AutopilotStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_core__msg__AutopilotStatus;
    is_plain =
      (
...
static size_t _AutopilotStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vehicle_core__msg__AutopilotStatus(
...
static message_type_support_callbacks_t __callbacks_AutopilotStatus = {
  "vehicle_core::msg",
  "AutopilotStatus",
...
static rosidl_message_type_support_t _AutopilotStatus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AutopilotStatus,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_core, msg, AutopilotStatus)() {
  return &_AutopilotStatus__type_support;
}
