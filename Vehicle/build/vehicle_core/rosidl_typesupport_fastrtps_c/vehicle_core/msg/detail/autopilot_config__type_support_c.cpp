...
#include "vehicle_core/msg/detail/autopilot_config__rosidl_typesupport_fastrtps_c.h"
...
using _AutopilotConfig__ros_msg_type = vehicle_core__msg__AutopilotConfig;

static bool _AutopilotConfig__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AutopilotConfig__ros_msg_type * ros_message = static_cast<const _AutopilotConfig__ros_msg_type *>(untyped_ros_message);
...
static bool _AutopilotConfig__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _AutopilotConfig__ros_msg_type * ros_message = static_cast<_AutopilotConfig__ros_msg_type *>(untyped_ros_message);
  // Field name: profile_id
  {
    cdr >> ros_message->profile_id;
  }
...
size_t get_serialized_size_vehicle_core__msg__AutopilotConfig(
  const void * untyped_ros_message,
...
static uint32_t _AutopilotConfig__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vehicle_core__msg__AutopilotConfig(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vehicle_core
size_t max_serialized_size_vehicle_core__msg__AutopilotConfig(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vehicle_core__msg__AutopilotConfig;
    is_plain =
      (
...
static size_t _AutopilotConfig__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_vehicle_core__msg__AutopilotConfig(
...
static message_type_support_callbacks_t __callbacks_AutopilotConfig = {
  "vehicle_core::msg",
  "AutopilotConfig",
  _AutopilotConfig__cdr_serialize,
  _AutopilotConfig__cdr_deserialize,
  _AutopilotConfig__get_serialized_size,
  _AutopilotConfig__max_serialized_size
};

static rosidl_message_type_support_t _AutopilotConfig__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AutopilotConfig,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vehicle_core, msg, AutopilotConfig)() {
  return &_AutopilotConfig__type_support;
}
